...
import SubDealerPurchaseHistoryReceipt from "./SubDealerPurchaseHistoryReceipt";

const SubDealerPurchaseHistoryTable = ({
  transactions,
  showHeader,
          ...
          <div>
            <Card>
              <CardBody>
                ...
                <SubDealerPurchaseHistoryReceipt
                  show={show}
...
export default SubDealerPurchaseHistoryTable;
