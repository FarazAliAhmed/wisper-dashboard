      ...
      <Modal centered isOpen={confirm} toggle={() => setConfirm(!confirm)}>
        <ModalBody>
          <div className="confirm text-center">
            <h5>Confirm Data Purchase</h5>
            {/* <img src={warning} width={50} className="confirm-warn" alt="warn" /> */}
            <p className="text-center">Data Volume: {amount}GB</p>
            <p className="text-center">Price/GB: ₦{price}</p>
            <p className="text-center">Cost of Data: ₦{cost}</p>
          </div>
        </ModalBody>
